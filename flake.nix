{
  ...
  inputs.wasi-preview1-command-component-adapter.url = "https://github.com/bytecodealliance/wasmtime/releases/download/v18.0.1/wasi_snapshot_preview1.command.wasm";
  inputs.wasi-preview1-reactor-component-adapter.flake = false;
  inputs.wasi-preview1-reactor-component-adapter.url = "https://github.com/bytecodealliance/wasmtime/releases/download/v18.0.1/wasi_snapshot_preview1.reactor.wasm";
