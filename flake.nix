{
  ...
  inputs.wasi-preview1-command-component-adapter.url = "https://github.com/ricochet/wasmtime/releases/download/v16.0.0-rc.2/wasi_snapshot_preview1.command.wasm";
  inputs.wasi-preview1-reactor-component-adapter.flake = false;
  inputs.wasi-preview1-reactor-component-adapter.url = "https://github.com/ricochet/wasmtime/releases/download/v16.0.0-rc.2/wasi_snapshot_preview1.reactor.wasm";
